...
export async function createOrder(req,res){
     ...
     try{
        ...
        if(lastOrder != null){
            ...
            const lastOrderNumber = parseInt(lastOrderNumberInString) //26 - using ParseInt ---> string to number

            const newOrderNumber = lastOrderNumber + 1 //27
            const newOrderNumberInString = newOrderNumber.toString().padStart(6, "0") //"000027" padStart(6, "0") ---> 6 digits, if less than 6 digits, add 0 in front of the number.
